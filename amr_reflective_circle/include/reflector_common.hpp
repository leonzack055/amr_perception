...
inline Eigen::Quaterniond ToEigen(const geometry_msgs::msg::Quaternion & quaternion)
{
...
inline Rigid3d ToRigid3d(const geometry_msgs::msg::TransformStamped & transform)
{
  return Rigid3d(
...
inline Rigid3d ToRigid3d(const geometry_msgs::msg::Pose & pose)
{
  return Rigid3d(
...
inline geometry_msgs::msg::Point ToGeometryMsgPoint(const Eigen::Vector3d & vector3d)
{
...
inline geometry_msgs::msg::Transform ToGeometryMsgTransform(const Rigid3d & rigid3d)
{
...
inline geometry_msgs::msg::Pose ToGeometryMsgPose(const Rigid3d & rigid3d)
{
